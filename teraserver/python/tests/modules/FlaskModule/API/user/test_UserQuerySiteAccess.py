...
class UserQuerySiteAccessTest(BaseUserAPITest):
    ...
    def test_post_and_delete(self):
        ...
        response = self._post_with_user_http_auth(self.test_client, username='user', password='user', json=json_data)
        ...
        response = self._delete_with_user_http_auth(self.test_client, username='user4', password='user4', params=params)
