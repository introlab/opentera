...
class TeraDevice(db.Model, BaseModel):
    ...
    def create_defaults():
        ...
        device.device_type = TeraDeviceType.get_device_type_by_name('CAPTEUR').id_device_type
        # device.create_token()
        ...
        device2.device_type = TeraDeviceType.get_device_type_by_name('VIDEOCONFERENCE').id_device_type
        ...
        device3.device_type = TeraDeviceType.get_device_type_by_name('ROBOT').id_device_type
