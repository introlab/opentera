...
class BureauActifCalendarData(db.Model, BaseModel):
    ...
    def create_defaults():
        ...
        thirteenth_data1.remaining = 1.0
        ...
        thirteenth_data2.remaining = 1.0
