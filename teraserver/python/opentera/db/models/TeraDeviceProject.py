...
class TeraDeviceProject(db.Model, BaseModel):
    ...
    device_project_project = db.relationship("TeraProject", viewonly=True, lazy='joined')
    device_project_device = db.relationship("TeraDevice", viewonly=True, lazy='joined')
