# FIXME: Delete this file on OpenTera package 1.2.0 release (as opentera.db.Base will be used instead)
import inspect
import datetime
# import uuid
import time
...
class _QueryProperty:
    def __get__(self, obj: Model, cls: t.Type[Model]) -> BaseQuery:
